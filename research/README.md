# Nokia Beacon 3.1 — Research Index

This folder contains dated evidence, not general user instructions.

## Current baseline

- [Normal-Admin Access Baseline](admin-access-baseline-2026-08-19.md)
- [Normal-Admin Access Inventory](admin-access-inventory.md)
- [Runtime Read Baseline](runtime-read-baseline-2026-08-19.md)
- [Comprehensive Passive Inventory](comprehensive-passive-inventory-2026-08-19.md)

## Authorized-CGI and permissions
...
- [GenericService Request Envelope](service-function-envelope.md)

## Hidden features

- [Hidden-Feature Read Shapes](hidden-feature-read-shapes-2026-08-19.md)
- [RRM and Network Optimization](rrm-network-optimization-static-classification-2026-08-19.md)
